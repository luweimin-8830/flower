...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,127.0.2.2,127.0.2.3,192.168.4.227,172.16.0.2";
  const port = "8090";
  const id = "mp-weixin_e8ZXz4";
...
const pages = [
  ...
  {
    path: "pages/familyDetail/familyDetail",
    style: {
      navigationBarTitleText: "",
      navigationStyle: "custom",
      enablePullDownRefresh: false,
  ...
  {
    path: "pages/shareMember/shareMember",
    style: {
      navigationBarTitleText: "",
      navigationStyle: "custom",
      enablePullDownRefresh: false,
  ...
  {
    path: "pages/shareDetail/shareDetail",
    style: {
  ...
  {
    path: "pages/displayRoom/displayRoom",
    style: {
      navigationBarTitleText: "陈列室",
      navigationStyle: "custom",
      enablePullDownRefresh: false,
      disableScroll: false
    }
  ...
  {
    path: "pages/sharePlantList/sharePlantList",
    style: {
